...
BEGIN
  FOREACH table_name IN ARRAY ARRAY['FinancialFact', 'ReportedFinancialStatement'] LOOP
    ...
    IF missing <> 0 THEN RAISE EXCEPTION '% has % orphan issuer records', table_name, missing; END IF;
