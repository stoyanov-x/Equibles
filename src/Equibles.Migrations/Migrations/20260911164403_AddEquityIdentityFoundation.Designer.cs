...
namespace Equibles.Migrations.Migrations
{
    ...
    [Migration("20260911164403_AddEquityIdentityFoundation")]
    partial class AddEquityIdentityFoundation
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("EquityListing", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_EquityListing_Ticker", "length(btrim(\"Ticker\")) > 0 AND \"Ticker\" = btrim(\"Ticker\") AND \"Ticker\" = upper(\"Ticker\")");
                        });
                });
